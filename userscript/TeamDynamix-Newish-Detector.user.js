...
// @match        *://*/TDWorkManagement*
// @grant        none
// @run-at       document-end
// ==/UserScript==

// this checks to see what version of tdx is being used, and runs the correct script accordingly
if (/^https?:\/\/[^/]+\/TDNext\/Home\/Desktop\/[^/]+\.aspx$/i.test(location.href)) {
...
// newer version with TDWorkManagement
} else if (/^https?:\/\/[^/]+\/TDWorkManagement\/?$/i.test(location.href)) {
